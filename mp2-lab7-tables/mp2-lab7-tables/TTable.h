...
{
protected:
	//Счётчик числа записей (общий для всех видов таблиц)
	int DataCount;
	//Счётчик эффективности выполнения той или иной операции
	int Eff;
public:
	TTable();
	virtual ~TTable();
	...
	//Поиск записи (будет устанавливать некоторый current на эту запись)
